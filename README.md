This is a [Next.js](https://nextjs.org/) project that demonstrates how to visualize data from [MySQL](https://www.mysql.com/) using [Flexmonster](https://www.flexmonster.com/) and [Recharts](https://recharts.org/en-US).
